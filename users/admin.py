...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'email', 'first_name', 'last_name', 'get_department', 'get_status', 'is_active', 'is_staff')
...
class RoleAdmin(admin.ModelAdmin):
    list_display = ('id', 'group_name', 'description', 'is_system_role', 'priority', 'parent_role')
...
class DataPermissionAdmin(admin.ModelAdmin):
    list_display = ('id', 'content_type', 'object_id', 'permission_type', 'user', 'group')
