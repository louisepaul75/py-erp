...
try:
    ...
    def analyze_artikel_variante(sample_size=10):
        ...
        try:
            ...
            potential_fk_fields = [
                ...
                or col.endswith("_id")
                or col.endswith("ID")
                or "artnr" in col.lower()
                or col == "refOld"
            ]  # Added refOld as it seems to reference Artikel_Stamm
            ...
            if "Familie_" in df.columns:
                ...
                print(
                    f"This suggests that variants are grouped into {unique_families} product families",
                )
    ...
    if __name__ == "__main__":
        ...
        if df is not None and not df.empty:
            ...
            print(
                "3. Consider mapping Artikel_Variante to product variants in the new system",
            )
