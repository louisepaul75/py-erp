    ...
    def list_all_tables():
        ...
        for table in possible_tables:
            try:
                ...
                print(f"✗ Table {table} check failed: {error_message}")
        ...
        try:
            ...
            if av_df is not None and len(av_df) > 0:
                ...
                if category_cols:
                    print(
                        "Potential category/family related columns in Artikel_Variante:",
                    )
            ...
            print(f"Error checking Artikel_Variante: {e!s}")
            traceback.print_exc()
