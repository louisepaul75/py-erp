...
def search_all_produktfotos_for_sku(sku, limit_pages=10):
    ...
    for page in range(1, total_pages + 1):
        ...
        for image_data in data.get('results', []):
            ...
            for article in articles:
                ...
                if article_number == sku or article_number.startswith(sku) or sku.startswith(article_number):
                    # Parse the image
    ...
    if found_images:
        ...
        for img in found_images:
            print(f"- Article: {img['article_number']}, Type: {img['image_type']}, Front: {img['is_front']}")
