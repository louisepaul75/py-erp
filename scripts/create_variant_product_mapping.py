...
print(
    "will be handled by the custom map_variant_product_fields function in sync_tasks.py",
)
print(
    "\nIf you encounter 404 errors when trying to sync, you may need to update the legacy_table",
)
print(
    "value in the EntityMappingConfig to match the actual table name in the legacy system.",
)
