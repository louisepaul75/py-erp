...
def create_placeholder_parents():
    ...
    print("These placeholder parents will use data from their variants with a 'PLACEHOLDER' prefix.")
    ...
    with transaction.atomic():
        for variant in variants_without_parent:
            try:
                ...
                print(f"Created placeholder parent {parent.sku} for variant {variant.sku}")
            except Exception as e:
                errors += 1
                print(f"Error processing variant {variant.sku}: {str(e)}")
