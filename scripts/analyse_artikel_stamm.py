...
try:
    ...
    def analyze_artikel_stamm():
        ...
        try:
            ...
            print(f"{'='*80}")
            categorical_fields = [col for col in df.columns if df[col].dtype == 'object' and df[col].nunique() < 10]
            ...
            output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'artikel_stamm_sample.csv')
