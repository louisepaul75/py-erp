...
def check_product_table_structure():
    ...
    with connection.cursor() as cursor:
        ...
        if has_is_parent and has_parent_id:
            ...
            print("Variant products have is_parent=False and parent_id pointing to their parent product")
        else:
...
def count_products_by_type():
    ...
    parents_with_variants = Product.objects.filter(is_parent=True).annotate(
