      ...
      <CardContent className="p-0">
        {isLoading ? (
          ...
          <ul className="divide-y divide-border">
            {results.map((result) => {
              const Icon = TypeIcons[result.type as keyof typeof TypeIcons] || Package;
                ...
                >
                  ...
                  <div className="flex-1 overflow-hidden">
                    <div className="font-medium">
                      {result.name || result.customer_number || result.record_number || 
                       result.sku || result.barcode || result.legacy_id || "Unbekannt"}
                    </div>
