              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    <TableHead className="font-medium w-1/4 dark:text-gray-100">
                      Lager
                      <ChevronUp className="inline-block ml-1 h-4 w-4" />
                    </TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Regal</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Fach</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Boden</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Schütte</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Slot(s)</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Abverkauf</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Sonder</TableHead>
                    <TableHead className="font-medium dark:text-gray-100">Bestand</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
