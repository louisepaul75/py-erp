...
from pyerp.legacy_sync.models import SyncLog, EntityMapping, EntityMappingConfig, TransformationFunction
...
class EntityMappingConfigAdmin(admin.ModelAdmin):
    ...
    list_display = ('entity_type', 'legacy_table', 'new_model', 'is_active', 'updated_at')
