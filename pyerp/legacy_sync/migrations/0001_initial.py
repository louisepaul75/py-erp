        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "new_id",
                    models.CharField(
                        help_text="ID of the entity in the new system",
                        max_length=100,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        auto_now=True,
                        help_text="When the entity was last synchronized",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["entity_type"],
                        name="legacy_sync_entity__93f97b_idx",
                    ),
                    models.Index(
                        fields=["status"],
                        name="legacy_sync_status_dadb42_idx",
                    ),
                    models.Index(
                        fields=["started_at"],
                        name="legacy_sync_started_d77697_idx",
                    ),
                ],
            },
        ),
