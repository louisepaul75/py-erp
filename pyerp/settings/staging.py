...
if DEBUG and os.environ.get('ENABLE_DEBUG_TOOLBAR', 'False').lower() == 'true':
    ...
    INTERNAL_IPS = ['127.0.0.1']  # noqa: F841
    DEBUG_TOOLBAR_CONFIG = {  # noqa: F841
...
ADMINS = [('Developer', email) for email in os.environ.get('ADMIN_EMAILS', '').split(',') if email]  # noqa: E501
...
CELERY_TASK_ALWAYS_EAGER = os.environ.get('CELERY_TASK_ALWAYS_EAGER', 'False').lower() == 'true'  # noqa: E501
