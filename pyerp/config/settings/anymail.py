...
ANYMAIL = {
    ...
    "SMTP_PORT": (
        int(os.environ.get("EMAIL_PORT", 587)) if os.environ.get("EMAIL_PORT") else 587
    ),
...
# Anymail logging configuration
ANYMAIL_LOG_LEVEL = os.environ.get("ANYMAIL_LOG_LEVEL", "INFO")
LOGGING = {
    "version": 1,
