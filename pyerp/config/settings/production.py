...
CACHES = {
    'default': {
    'BACKEND': 'django_redis.cache.RedisCache',  # noqa: E128
...
EMAIL_BACKEND = os.environ.get('EMAIL_BACKEND', 'django.core.mail.backends.console.EmailBackend')  # noqa: E501
EMAIL_HOST = os.environ.get('EMAIL_HOST', '')  # noqa: F841
EMAIL_PORT = int(os.environ.get('EMAIL_PORT', '587') if os.environ.get('EMAIL_PORT') else '587')  # noqa: E501
