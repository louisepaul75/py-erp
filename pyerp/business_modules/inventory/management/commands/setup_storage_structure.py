...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            'Setting up dual-table storage structure...'
        ))
        ...
        self.stdout.write(self.style.SUCCESS(
            'Dual-table storage structure setup complete!'
        ))
    ...
    def _run_migrations(self, force=False):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(
                'Created migrations for the new schema'
            ))
        except Exception as e:
            self.stdout.write(self.style.ERROR(
                f'Error creating migrations: {e}'
            ))
            raise
    ...
    def _setup_sync(self):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(
                f'Error setting up synchronization: {e}'
            ))
            raise
