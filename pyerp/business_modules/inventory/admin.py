...
class StorageLocationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Flags"), {"fields": ("sale", "special_spot")}),
        (
...
class BoxTypeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Dimensions"), {"fields": ("length", "width", "height", "weight_empty")}),
        (_("Slot Configuration"), {"fields": ("slot_count", "slot_naming_scheme")}),
    )
...
class ProductStorageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Product Information"), {"fields": ("product", "quantity")}),
        (_("Storage Location"), {"fields": ("storage_location",)}),
        (_("Reservation"), {"fields": ("reservation_status", "reservation_reference")}),
    )
    inlines = [BoxStorageInline]
...
class BoxStorageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Box Location"), {"fields": ("box_slot", "position_in_slot")}),
    )
