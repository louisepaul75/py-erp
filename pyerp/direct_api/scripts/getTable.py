...
try:
    ...
    logger.error("Make sure the settings module is available and correctly configured")  # noqa: E501
    sys.exit(1)
...
class SimpleAPIClient:
    ...
    def __init__(self, environment='live'):
        ...
        if environment not in API_ENVIRONMENTS:
            ...
            raise ValueError(f"Invalid environment: '{environment}'. Available: {available_envs}")  # noqa: E501
        ...
        if 'base_url' not in API_ENVIRONMENTS[environment]:
            ...
            raise KeyError(f"Missing 'base_url' in API_ENVIRONMENTS['{environment}']")  # noqa: E501
        ...
        try:
            if cookie_name in self.session.cookies:
                ...
                if remaining > 0:
                    ...
                    logger.info(f"Successfully cleared all {cookie_name} cookies")  # noqa: E501
        except Exception as e:
    ...
    def validate_session(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning(f"Session validation failed: {response.status_code}")  # noqa: E501
                if response.text:
    ...
    def login(self):
        ...
        try:
            ...
            if wasid_cookie:
                ...
                logger.info(f"Set single WASID4D cookie using 4DSID value: {safe_id}")  # noqa: E501
                self.save_session_cookie()
                return True
            else:
                logger.warning("No session cookies received during login attempt")  # noqa: E501
                return False
        except Exception as e:
    ...
    def fetch_table(self, table_name, top=100, skip=0, all_records=False,
                    filter_query=None, new_data_only=True, date_created_start=None):  # noqa: E501
        """
        ...
        if all_records:
            ...
            try:
                ...
                if response.status_code != 200 and '$filter' in params:
                    ...
                    response = self.session.get(url, params=params_without_filter)  # noqa: E501
            except Exception as e:
            ...
            if 'value' in data and isinstance(data['value'], list):
                ...
                if '__ENTITIES' in data and isinstance(data['__ENTITIES'], list):  # noqa: E501
                    ...
                    try:
                        ...
                        logger.warning(f"Failed to convert response dict to DataFrame: {e}")  # noqa: E501
  ...
  # noqa: E501, F841
                        if retry_count < max_retries:
                            ...
                            if self.login():
                                retry_count += 1
                                logger.info(f"Re-login successful. Retrying request (attempt {retry_count}/{max_retries})")  # noqa: E501
                                continue
                        error_msg += ": Maximum number of sessions reached and retry failed"  # noqa: E501
                ...
                if 'value' in data and isinstance(data['value'], list):
                    ...
                    logger.warning("Response does not contain expected data format")  # noqa: E501
