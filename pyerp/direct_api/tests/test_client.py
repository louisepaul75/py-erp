...
from pyerp.direct_api.exceptions import ResponseError, ConnectionError, DataError
...
class TestDirectAPIClient(unittest.TestCase):
    ...
    def test_fetch_table_error_handling(self, mock_make_request):
        ...
        mock_make_request.side_effect = ResponseError(404, "Not found", "Resource not found")
    ...
    def test_push_field_success(self, mock_make_request):
        ...
        # Call the method
        result = self.client.push_field('Artikel_Familie', 'key1', 'Bezeichnung', 'New Name')
    ...
    def test_push_field_error(self, mock_make_request):
        ...
        # Setup mock to raise an exception
        mock_make_request.side_effect = ResponseError(404, "Not found", "Record not found")
        
        # Verify the exception is propagated
        with self.assertRaises(ResponseError):
            self.client.push_field('Artikel_Familie', 'invalid_key', 'Bezeichnung', 'New Name')
