...
class ImageAPIClient:
    ...
    def __init__(self):
        ...
        self.base_url = settings.IMAGE_API.get('BASE_URL', 'http://webapp.zinnfiguren.de/api/')  # noqa: E501
        self.username = settings.IMAGE_API.get('USERNAME')
        self.password = settings.IMAGE_API.get('PASSWORD')
        self.timeout = settings.IMAGE_API.get('TIMEOUT', 60)  # Increased default timeout  # noqa: E501
 ...
 # Check if the response is in cache
        ...
        try:
            ...
            response = self.session.get(
                url,  # noqa: E128
                params=params,
                timeout=self.timeout,  # noqa: F841
                verify=self.verify_ssl  # Use the SSL verification setting  # noqa: F841
            )
 ...
 # Cache the response if caching is enabled
                ...
                logger.error(f"API request failed with status code: {response.status_code}")  # noqa: E501
 ...
 # Track highest resolution PNG and JPEG for primary image selection  # noqa: E501
                ...
                elif img_format in ('jpg', 'jpg_k', 'jpg_g', 'jpeg') and resolution:  # noqa: E501
                    total_pixels = resolution[0] * resolution[1] if len(resolution) >= 2 else 0  # noqa: E501
 ...
 # Set front flag and add article info
        ...
        for article in image_data.get('articles', []):
            result['articles'].append({
                'article_number': article.get('number', ''),  # noqa: E128
