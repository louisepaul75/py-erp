            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="When the sync process started",
                    ),
                ),
                (
                    "completed_at",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Number of new images added",
                    ),
                ),
                (
                    "images_updated",
                    models.IntegerField(
                        default=0,
                        help_text="Number of existing images updated",
                    ),
                ),
                (
                    "images_deleted",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Number of products affected by the sync",
                    ),
                ),
                (
                    "error_message",
                    models.TextField(
                        blank=True,
                        help_text="Error message if the sync failed",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Short product description in English",
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Minimum stock quantity before reordering",
                    ),
                ),
                (
                    "backorder_quantity",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Quantity on open purchase orders",
                    ),
                ),
                (
                    "last_receipt_date",
                    models.DateField(
                        blank=True,
                        help_text="Date of last stock receipt",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date of last stock issue",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Units sold in current year",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Units sold in previous year",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether the product is discontinued",
                    ),
                ),
                (
                    "has_bom",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether the product is one-sided",
                    ),
                ),
                (
                    "is_hanging",
                    models.BooleanField(
                        default=False,
                        help_text="Whether the product is hanging",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Base SKU for variants",
                        max_length=50,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date of last customer order",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "external_id",
                    models.CharField(
                        help_text="ID from external image database",
                        max_length=255,
                    ),
                ),
                (
                    "image_url",
                    models.URLField(
                        help_text="URL to the full-size image",
                        max_length=500,
                    ),
                ),
                (
                ...
                (
                    "image_type",
                    models.CharField(
                        help_text='Type of image (e.g., "Produktfoto")',
                        max_length=50,
                    ),
                ),
                (
