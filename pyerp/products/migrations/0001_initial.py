    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_placeholder', models.BooleanField(default=False, help_text='Indicates if this is a placeholder parent created for orphaned variants')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_ordered_date', models.DateField(blank=True, help_text='Date when this variant was last ordered', null=True)),
                ('parent', models.ForeignKey(help_text='Parent product - maps to Familie_ field in Artikel_Variante which references __KEY in Artikel_Familie', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='variants', to='products.parentproduct')),
            ],
            options={
