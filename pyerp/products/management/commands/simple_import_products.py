"""
Management command to populate the ParentProduct and VariantProduct tables with sample data.
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.NOTICE(f'Starting import of {parent_count} parent products and {parent_count * variants_per_parent} variants...'))
        ...
        if not dry_run:
            ...
            self.stdout.write(self.style.SUCCESS(f'Final product counts - Parents: {parent_count_db}, Variants: {variant_count_db}'))
