...
This module provides integration between Django forms and the validation framework,
allowing reuse of validators and consistent validation behavior across the application.
"""
...
from pyerp.core.validators import Validator, ValidationResult
...
class ValidatedFormMixin:
    ...
    def add_form_validator(self, validator_func: Callable[[Dict[str, Any]], ValidationResult]):
        """
    ...
    def clean(self):
        ...
        for field_name in list(cleaned_data.keys()):
            if field_name in self.field_validators:
                # The individual field clean methods will be called automatically
                pass
