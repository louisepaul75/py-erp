...
class AuditService:
    ...
    def log_event(cls, event_type, message, user=None, request=None,
        ...
        Args:
            ...
            request (HttpRequest, optional): The request that triggered the event  # noqa: E501
            obj (Model, optional): Related object
            additional_data (dict, optional): Additional data to store with the event  # noqa: E501
