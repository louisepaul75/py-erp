            ...
            try:
                ...
                for component_name, component_config in config.items():
                    ...
                    try:
                        ...
                        loader_config = component_config.get("loader", {}).get("config", {})
                        ...
                        mapping_config = {
                            ...
                            "custom_transformers": transformer_config.get("config", {}).get("custom_transformers", []),
                        ...
                        self.stdout.write(
                            self.style.ERROR(f"Error processing component {component_name}: {e}")
                        )
                        continue
