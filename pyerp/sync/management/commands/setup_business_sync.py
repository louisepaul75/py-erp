"""Management command for setting up business sync mapping."""
...
class Command(BaseCommand):
    """Set up business sync mappings."""

    help = "Set up sync mapping for business components (employees, etc.)"

    def handle(self, *args, **options):
        """Execute the command."""
        self.stdout.write("Setting up business sync mapping...")
        ...
        self.stdout.write(
            self.style.SUCCESS("Business sync mapping setup completed successfully")
        )
    ...
    def _setup_component_sync(self, component_key: str, config: dict) -> None:
        ...
        app_name = target_config.get("app_name", "business")
