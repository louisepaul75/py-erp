    ...
    try:
        ...
        if server_url is None and access_token is None:
            try:
                ...
                logger.warning(
                    f"Failed to create 1Password client from environment: {str(e)}"
                )
...
def get_secret(
    item_name, field_name=None, vault=None, server_url=None, access_token=None
):
    """
...
def get_email_password(
    email_username=None, item_name=None, vault=None, server_url=None, access_token=None
):
    """
