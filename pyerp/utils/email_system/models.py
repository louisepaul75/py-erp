...
class EmailLog(models.Model):
    ...
    subject = models.CharField(
        _("Subject"), max_length=255, help_text=_("Email subject")
    )
    from_email = models.EmailField(_("From Email"), help_text=_("Sender email address"))
    to_email = models.TextField(
        _("To Email"), help_text=_("Recipient email address(es), comma separated")
    )
    ...
    body_html = models.TextField(
        _("Body HTML"), blank=True, null=True, help_text=_("HTML content of the email")
    )
    ...
    opens = models.IntegerField(
        _("Opens"), default=0, help_text=_("Number of times the email was opened")
    )
    ...
    created_at = models.DateTimeField(
        _("Created At"), auto_now_add=True, help_text=_("When the email was created")
    )
    ...
    sent_at = models.DateTimeField(
        _("Sent At"), blank=True, null=True, help_text=_("When the email was sent")
    )
...
class EmailEvent(models.Model):
    ...
    timestamp = models.DateTimeField(
        _("Timestamp"), auto_now_add=True, help_text=_("When the event occurred")
    )
