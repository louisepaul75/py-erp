  ...
  <div class="container mx-auto py-10">
    ...
    >
      <div class="bg-white rounded-lg p-6 max-w-md w-full">
        ...
        <p class="mb-6">
          Sind Sie sicher, dass Sie die Gruppe "{{ groupToDelete?.name }}" löschen möchten? Diese
...
const groups = ref([
  { id: '1', name: 'Administratoren', userCount: 3, permissions: ['Vollzugriff'] },
  {
    ...
    name: 'Buchhaltung',
    userCount: 5,
    permissions: ['Rechnungen ansehen', 'Rechnungen erstellen']
  },
  {
    id: '3',
    name: 'Vertrieb',
    userCount: 8,
    permissions: ['Kunden ansehen', 'Angebote erstellen']
  },
