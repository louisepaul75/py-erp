  ...
  <div class="customer-form">
    ...
    <form @submit.prevent="saveCustomer">
      <div class="card">
        ...
        <div class="form-row">
          <div class="form-group">
            <label for="first_name">First Name <span v-if="!form.is_company" class="required">*</span></label>
            <input 
              id="first_name" 
          ...
          <div class="form-group">
            <label for="last_name">Last Name <span v-if="!form.is_company" class="required">*</span></label>
            <input 
              id="last_name" 
      ...
      <div class="card">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            />
            <div v-if="errors.billing_street" class="error-message">{{ errors.billing_street }}</div>
          </div>
          ...
          <div class="form-group narrow">
            ...
            />
            <div v-if="errors.billing_street_number" class="error-message">{{ errors.billing_street_number }}</div>
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group narrow">
            ...
            />
            <div v-if="errors.billing_postal_code" class="error-message">{{ errors.billing_postal_code }}</div>
          </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <div v-if="errors.billing_country" class="error-message">{{ errors.billing_country }}</div>
          </div>
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <div class="flex flex-wrap gap-4">
            <label class="inline-flex items-center" v-for="method in paymentMethods" :key="method.value">
              <input 
                type="checkbox" 
                :value="method.value" 
      ...
      <div class="card">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <select 
              id="postal_advertising" 
              v-model="form.postal_advertising"
              class="form-select"
            >
              <option value="Yes">Yes</option>
              <option value="No">No</option>
          ...
          <div class="form-group">
            ...
            <select 
              id="email_advertising" 
              v-model="form.email_advertising"
              class="form-select"
            >
              <option value="Yes">Yes</option>
              <option value="No">No</option>
...
:deep(.form-radio), :deep(.form-checkbox) {
