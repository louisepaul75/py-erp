...
from pyerp.core.middleware import DatabaseConnectionMiddleware, AuthExemptMiddleware
...
class TestAuthExemptMiddleware(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        self.factory = RequestFactory()
        self.middleware = AuthExemptMiddleware(self._get_response)
    ...
    def test_auth_exempt_with_custom_response(self):
        ...
        response = self.middleware.process_response(request, custom_response)
