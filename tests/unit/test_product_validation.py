...
from tests.unit.mock_models import (
    MockProduct,
    MockProductCategory,
    MockQuerySet
)
...
class TestProductValidation:
    ...
    def test_parent_variant_validation(self):
        ...
        if is_parent and variant_code:
            ...
            assert error_message, "Should raise an error for parent products with variant codes"  # noqa: E501
    ...
    def test_price_validation(self):
        ...
        if list_price and cost_price and list_price < cost_price:
            ...
            assert error_message, "Should raise an error when list price is less than cost price"  # noqa: E501
    ...
    def test_price_range_validation(self):
        ...
        if min_price and max_price and min_price > max_price:
            ...
            assert error_message, "Should raise an error when min price is greater than max price"  # noqa: E501
...
class TestProductCategoryValidation:
    ...
    def test_category_code_uniqueness(self):
        ...
        mock_queryset = MockQuerySet(
            [MockProductCategory(code='DUPLICATE-CAT')])
        mock_queryset.exists_return = True
        mock_filter.return_value = mock_queryset
...
class TestProductImageValidation:
    ...
    def test_primary_image_validation(self):
        ...
        assert primary_count == 1, "A product should have exactly one primary image"  # noqa: E501
