...
class TestProductValidation:
    ...
    def test_parent_variant_validation(self):
        ...
        if is_parent and variant_code:
            ...
            assert error_message, "Should raise an error for parent products with variant codes"
    ...
    def test_price_range_validation(self):
        ...
        if min_price and max_price and min_price > max_price:
            ...
            assert error_message, "Should raise an error when min price is greater than max price"
