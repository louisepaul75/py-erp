...
class TestImportValidator:
    ...
    def test_validate_row_valid(self, test_validator):
        ...
        # Validate row
        is_valid, validated_data, resultt = test_validator.validate_row(
            row_data)
    ...
    def test_validate_row_with_errors(self, validator):
        ...
        assert 'Name must be at least 3 characters' in resultt.errors['name'][0]  # noqa: E501
    ...
    def test_strict_validation(self, strict_validator):
        ...
        is_valid, validated_data, resultt = strict_validator.validate_row(
            row_data)
    ...
    def test_cross_validation(self, validator):
        ...
        assert "Items with 'inactive' in the name must be set as inactive" in resultt.errors[  # noqa: E501
            'active'][0]
...
class TestProductImportCommand:
    ...
    def test_create_product_validator(self, command):
        ...
        with patch('pyerp.products.validators.ProductImportValidator') as mock_validator_class:  # noqa: E501
    ...
    def test_validate_products(self, command):
        ...
        valid_resultt = (
            True, {
                'sku': 'VALID-1', 'name': 'Valid Product'}, MagicMock())
    ...
    def test_handle_product_validation(self, command):
        ...
        with patch('pyerp.products.models.ProductCategory.objects.get') as mock_get:  # noqa: E501
            default_category = MagicMock()
