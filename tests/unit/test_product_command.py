...
class TestProductImportCommand:
    ...
    def test_handle_product_validation(self, command):
        ...
        with patch('pyerp.products.models.ProductCategory', MockProductCategory):  # noqa: E501
            with patch.object(MockProductCategory, 'objects') as mock_category_objects:  # noqa: E501
