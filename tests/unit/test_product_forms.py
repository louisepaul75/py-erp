...
class TestProductForm:
    ...
    def test_clean_sku_duplicate_new_product(self, MockQuerySetClass):
        """Test that clean_sku raises an error for duplicate SKUs on new products."""  # noqa: E501
    ...
    @patch('tests.unit.mock_models.MockQuerySet')
    def test_clean_sku_existing_product(
            self, MockQuerySetClass, existing_product):
    ...
    def test_clean_parent_variant_validation(self):
        ...
        assert 'Parent products should not have variant codes.' in form.errors['variant_code']  # noqa: E501
    ...
    def test_clean_price_validation(self):
        ...
        assert 'List price must be greater than or equal to cost price.' in form.errors[  # noqa: E501
            'list_price']
...
class TestProductSearchForm:
    ...
    def test_search_form_invalid_price_range(self, invalid_search_data):
        ...
        assert 'Minimum price cannot be greater than maximum price.' in form.errors[  # noqa: E501
            'min_price']
