...
class TestValidationResult(unittest.TestCase):
    ...
    def test_add_error(self):
        ...
        self.assertEqual(result.errors["field1"], ["Error message 1", "Error message 2"])
    ...
    def test_add_warning(self):
        ...
        self.assertTrue(result.is_valid)
        self.assertEqual(result.warnings["field1"], ["Warning message 1", "Warning message 2"])
...
class TestRegexValidator(unittest.TestCase):
    ...
    def test_regex_validator_with_none(self):
        ...
        Note: The actual implementation treats None as valid or converts it to an empty string
        that matches the pattern. This behavior might be different from what we expect,
