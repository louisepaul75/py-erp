...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='htmlcov',
    ...
    if args.coverage:
        ...
        try:
            ...
            if coverage_file.exists():
                ...
                summary_cmd = [sys.executable, '-m', 'coverage', 'report', '--include=pyerp/*', '--omit=*/migrations/*,*/tests/*', '--format=text', '--skip-empty']
                print("\nCoverage Summary:")
                print("-" * 40)
