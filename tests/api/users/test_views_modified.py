...
from users.services import RoleService, PermissionService
...
class PermissionViewSetTest(TransactionTestCase):
    ...
    def test_permissions_by_category(self):
        ...
        user_cat = next(
            cat for cat in categorized_perms if cat["name"] == "User Management"
        )
        ...
        admin_cat = next(
            cat for cat in categorized_perms if cat["name"] == "Administration"
        )
